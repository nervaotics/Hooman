const { classifyShiftForDay } = require('./workShift.cjs')

const SALARY_STANDARD_DAYS = 26
const SALARY_STANDARD_DAY_HOURS = 8
...
function computeSalaryProcessingMetrics(attendanceRows, monthlyGross, opts = {}) {
...
module.exports = {
  SALARY_STANDARD_DAYS,
  computeSalaryProcessingMetrics,
}
